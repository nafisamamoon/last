...
import 'package:mylibarary/doctor-home.dart';
import 'package:mylibarary/emergency-home.dart';
import 'package:mylibarary/family-home.dart';
import 'package:mylibarary/global.dart';
import 'package:mylibarary/one-login-service.dart';
    ...
    return Scaffold(
      ...
      body:SingleChildScrollView(
        child: Stack(
          children: [
            Positioned.fill(
              child: Image(image: AssetImage('image/doctor.jpg'),
              fit: BoxFit.fill,
              height: 40,
              )
              ),
