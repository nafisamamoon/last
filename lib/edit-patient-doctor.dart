...
class EditPatientDoctor extends StatefulWidget {
  //const EditPatientDoctor({ Key? key }) : super(key: key);
int? id;
String? diagnosis;
EditPatientDoctor({this.id,this.diagnosis});
  @override
  _EditPatientDoctorState createState() => _EditPatientDoctorState();
}

class _EditPatientDoctorState extends State<EditPatientDoctor> {
